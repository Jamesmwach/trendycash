    ...
    <div class="min-h-screen gradient-bg flex items-center justify-center px-4">
      <div class="max-w-md w-full">
        ...
        <div class="text-center mb-8">
          ...
          <h2 class="text-2xl font-bold text-white mb-2">Join Trendy Cash</h2>
          <p class="text-blue-200">Start earning money today</p>
        </div>
        ...
        <div class="glass-effect rounded-2xl p-8">
          <form id="signupForm" class="space-y-6">
            <div>
              <label for="fullName" class="block text-white font-medium mb-2">Full Name</label>
              <input 
                type="text" 
                id="fullName" 
                required
            ...
            <div>
              <label for="referralCode" class="block text-white font-medium mb-2">Referral Code (Optional)</label>
              <input 
                type="text" 
                id="referralCode" 
                class="input-field bg-white bg-opacity-10 text-white placeholder-blue-200 border-white border-opacity-20"
            ...
            <div class="flex items-start">
              <input type="checkbox" id="terms" required class="mt-1 mr-3 rounded">
              <label for="terms" class="text-white text-sm">
                I agree to the 
                <a href="#terms" class="text-yellow-300 hover:text-yellow-200">Terms of Service</a> 
                and 
                <a href="#privacy" class="text-yellow-300 hover:text-yellow-200">Privacy Policy</a>
              </label>
            </div>
